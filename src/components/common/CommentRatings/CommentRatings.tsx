...
interface RatingsProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  descriptionRating?: (rating: number) => ReactNode;
}
...
const CommentRatings = ({
  ...
  return (
    <>
      <div className={cn('flex w-fit items-center gap-2 ')} onMouseLeave={handleMouseLeave} {...props}>
      ...
      {descriptionRating && descriptionRating(displayRating)}
    </>
  );
};
